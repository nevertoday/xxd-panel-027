...
| 模式 | 画幅逻辑 | 成品 |
| --- | --- | --- |
| `top-bottom` | 用户确认的整张成品画幅 | 一次生成完整画布：高保真原图在上，027 设计在下，约 50/50 |
| `left-right` | 用户确认的整张成品画幅 | 一次生成完整画布：高保真原图在左，027 设计在右，约 50/50 |
| `design-only` | 用户确认的整张成品画幅 | 027 设计铺满画布，不显示原照片 |
