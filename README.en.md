...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090444626285261046"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 027 sample 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090444626285261046"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 027 sample 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090444626285261046"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 027 sample 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2090444626285261046"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 027 sample 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 027 Sample 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 027 Sample 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 027 Sample 8"></td>
  </tr>
</table>

## Additional 3:4 Top–Bottom Samples

These four works reuse the same four independent sources as the 16:9 set above, now regenerated as complete 3:4 top–bottom canvases. The reality photograph stays above; the lower design follows Panel 027's original brief. English copy is generated only from each photograph's content, mood, or implication, and every result was individually reviewed.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 027 additional top-bottom sample 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 027 additional top-bottom sample 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 027 additional top-bottom sample 3"></td>
...
**Panel 027** is suited to work that must retain the source's essential content while pursuing this visual direction: **Press the photograph into a quiet Eastern museum bas-relief on ivory paper**. It begins with intended use and desired outcome; layout, size, text, and delivery format follow from those needs.
...
> Use XXD Panel 027 on this image and recommend the best layout and size first.
...
/xxd-panel-027 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-027 photo.jpg --mode design-only --size 9:16 --text prompt --locale ja-JP
...
/xxd-panel-027 photo.jpg --mode design-only --size 3:4 --text prompt --locale en-GB

# Use exact copy without rewriting, translating, or adding a title
/xxd-panel-027 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-027 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 027 to a whole directory; shared settings resolve once
/xxd-panel-027 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
...
- [Chinese runtime adapter](references/xxd-panel-027-prompt.zh-CN.md)
- [English runtime adapter](references/xxd-panel-027-prompt.en.md)
